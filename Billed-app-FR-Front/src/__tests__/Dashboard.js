...
// Tests liés à l'affichage des factures filtrées par statut
// // Test filtrage factures en attentes
describe("Given I am connected as an Admin", () => {
  ...
  // Test filtrage factures acceptées
  ...
  // Test filtrage factures refusées
  ...
  // Test du dépliage de la liste des factures sur le Dashboard
  describe("When I am on Dashboard page and I click on arrow", () => {
    test("Then, tickets list should be unfolding, and cards should appear", async () => {
      // Simulation d'une navigation vers la page du Dashboard
      const onNavigate = (pathname) => {
        document.body.innerHTML = ROUTES({ pathname });
      };

      // Simulation de l'utilisateur connecté en tant qu'Admin
      ...
      // Création d'une instance de Dashboard avec les données de factures
      ...
      // Ajout d'événements de clic sur les icônes de flèches et vérification du dépliage de la liste
...
describe("Given I am connected as Admin, and I am on Dashboard page, and I clicked on a pending bill", () => {
  ...
  describe("When I click on accept button", () => {
    test("I should be sent on Dashboard with big billed icon instead of form", () => {
      ...
      // Simulation d'une navigation vers la page du formulaire d'édition de la facture
      ...
      // Récupération du bouton d'acceptation et ajout d'un événement de clic
...
describe("Given I am a user connected as Admin", () => {
  describe("When I navigate to Dashboard", () => {
    test("fetches bills from mock API GET", async () => {
      ...
      const contentPending = await waitFor(() =>
        screen.getByText("En attente (1)")
      );
      expect(contentPending).toBeTruthy();
      const contentRefused = await waitFor(() =>
        screen.getByText("Refusé (2)")
      );
